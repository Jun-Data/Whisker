...
## 느낀점
이현준 : 1학기 관통 프로젝트는 Vue와 Django라는 기술 스택을 중심으로 진행되었고, 이는 기술적인 도전과 더불어 협업의 중요성을 체감하는 시간이었다. 구상한대로 구현하는 것이나 어떠한 툴을 사용하기 위해 검색을 하며 웹 개발을 위한 다양한 도구와 라이브러리가 있다는 것을 다시 한번 깨달을 수 있었다.
