<template>
  <header>
    <nav>
      ...
      <RouterLink :to="{ name: 'ProfileView' }"><button v-if="currentRoute.name !== 'ProfileView'">내 프로필</button></RouterLink>
    </nav>
    <br>
...
nav {
  ...
  flex-wrap: wrap; /* 버튼들이 너무 길어지면 자동으로 줄바꿈 */
}

nav button {
  padding: 5px 10px; /* 버튼 내 여백 추가 */
}
</style>
